...
namespace Gruas.API.Repositories.Interface
{
    public interface IServicioRepository
    {
        ...
        public Task<ResponseModel> GetCotizaciones(Guid id);
        ...
        public Task<ResponseModel> GetServiciosProximos(Guid usuarioId);
        ...
        public Task<ResponseModel> AsignarCotizacion(AsignarCotizaciones_Request model, Guid usuarioId);
    }
}
